...
def result():
    ...
    elif playerChoice == choices[0] and botChoice == choices[0]:
        print("Empate!")
    ...
    if playerChoice == choices[1] and botChoice == choices[0]:
        ...
        print("Bot venceu a partida!")
    elif playerChoice == choices[1] and botChoice == choices[1]:
        print("Empate!")
    ...
    if playerChoice == choices[2] and botChoice == choices[1]:
        ...
        print("Bot venceu a partida!")
    elif playerChoice == choices[2] and botChoice == choices[2]:
        print("Empate!")
